  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <section id="home" className="px-8 py-20 text-center bg-gray-50">
        ...
        <a href="https://wa.me/880XXXXXXXXXX" target="_blank" className="inline-block px-6 py-3 rounded-2xl bg-black text-white shadow">
          Order via WhatsApp
        </a>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[1, 2, 3].map((item) => (
            <div key={item} className="border rounded-2xl p-6 shadow-sm">
              ...
              <a href="https://wa.me/880XXXXXXXXXX" target="_blank" className="block text-center w-full py-2 rounded-xl border hover:bg-gray-50">
                Order on WhatsApp
              </a>
            </div>
          ))}
      ...
      <section id="contact" className="px-8 py-16">
        ...
        <div className="max-w-md mx-auto text-center text-gray-600 space-y-3">
          ...
          <p>💬 WhatsApp Orders: +880-XXXXXXXXXX</p>
